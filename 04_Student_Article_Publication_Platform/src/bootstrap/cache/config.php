<?php return array (
  ...
  'app' => 
  array (
    'name' => 'Student Article Publication Platform',
    'env' => 'local',
    'debug' => true,
    'url' => 'http://localhost',
    ...
    'faker_locale' => 'en_US',
    'cipher' => 'AES-256-CBC',
    'key' => 'base64:ICgWR2C+ghdcxsdO99ztXYipG5TBGBfN+FiOIbirN58=',
    'previous_keys' => 
    array (
    ),
    'maintenance' => 
  ...
  array (
    ...
    'prefix' => 'student-article-publication-platform-cache-',
  ),
  'database' => 
  array (
    'default' => 'mysql',
    ...
    array (
      ...
      array (
        'cluster' => 'redis',
        'prefix' => 'student-article-publication-platform-database-',
        'persistent' => false,
      ),
      'default' => 
      array (
  ...
  array (
    ...
    'from' => 
    array (
      'address' => 'noreply@article-platform.local',
      'name' => 'Student Article Publication Platform',
    ),
    'markdown' => 
    array (
  ...
  array (
    ...
    'cookie' => 'student-article-publication-platform-session',
    'path' => '/',
    'domain' => NULL,
    'secure' => NULL,
    'http_only' => true,
