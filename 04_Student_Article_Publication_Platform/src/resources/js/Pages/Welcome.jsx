...
import { Article, School, Create, Group } from '@mui/icons-material';
                ...
                <Container maxWidth="lg" sx={{ py: 8 }}>
                    <Box textAlign="center" mb={8}>
                        ...
                        <Typography variant="h5" color="text.secondary" sx={{ mb: 4 }}>
                            Share your knowledge, inspire others, and build your academic portfolio
                        </Typography>
                        {auth.user ? (
                            ...
                            <Card sx={{ height: '100%', textAlign: 'center', p: 2 }}>
                                <CardContent>
                                    ...
                                    <Typography variant="body2" color="text.secondary">
                                        Create beautiful articles with our integrated Jodit editor. Format text, add images, and create engaging content.
                                    </Typography>
                                </CardContent>
                            </Card>
                        </Grid>
                        ...
                        <Grid item xs={12} md={4}>
                            <Card sx={{ height: '100%', textAlign: 'center', p: 2 }}>
                                <CardContent>
                                    ...
                                    <Typography variant="body2" color="text.secondary">
                                        Designed specifically for students and educators. Perfect for assignments, research papers, and academic discussions.
                                    </Typography>
                                </CardContent>
                            </Card>
                        </Grid>
                        ...
                        <Grid item xs={12} md={4}>
                            <Card sx={{ height: '100%', textAlign: 'center', p: 2 }}>
                                <CardContent>
                                    ...
                                    <Typography variant="body2" color="text.secondary">
                                        Connect with fellow students and teachers. Share knowledge, get feedback, and collaborate on projects.
                                    </Typography>
                                </CardContent>
                            </Card>
                        </Grid>
                    ...
                    <Box textAlign="center" mt={8}>
                        <Typography variant="body2" color="text.secondary">
                            Built with Laravel {laravelVersion} & React • Powered by modern web technologies
                        </Typography>
                    </Box>
                </Container>
            </div>
