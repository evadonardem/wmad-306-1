        ...
        <>
            ...
            <div className="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
                ...
                <div className="relative flex min-h-screen flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                    <Container maxWidth="lg" className="relative px-6">
                        <header className="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                            ...
                            <nav className="-mx-3 flex flex-1 justify-end">
                                {auth.user ? (
                                    <Button component={Link} href={route('dashboard')} color="primary">
                                        Dashboard
                                    </Button>
                                ) : (
                                    <Box sx={{ display: 'flex', gap: 1 }}>
                                        ...
                                        <Button component={Link} href={route('register')} variant="contained" color="primary">
                                            Register
                                        </Button>
                                    </Box>
                                )}
                        ...
                        <main className="mt-6">
                            <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                <a
                                    ...
                                    id="docs-card"
                                    className="flex flex-col items-start gap-6 overflow-hidden bg-white p-6 shadow-md ring-1 ring-white/[0.05] transition duration-300 hover:shadow-lg md:row-span-3 lg:p-10 lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800"
                                >
                                    <div
                                ...
                                <a
                                    ...
                                    className="flex items-start gap-4 bg-white p-6 shadow-sm ring-1 ring-white/[0.05] transition duration-300 hover:shadow-md lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800"
                                >
                                    <div className="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                        <svg
                                            className="size-5 sm:size-6"
                                ...
                                >
                                    ...
                                    <div className="pt-3 sm:pt-5">
                                        ...
                                        <Typography variant="body2" sx={{ mt: 1.5 }}>
                                            Laravel News aggregates the latest and most important news in the Laravel ecosystem.
                                        </Typography>
                                    </div>
                                ...
                                <div className="flex items-start gap-4 bg-white p-6 shadow-sm ring-1 ring-white/[0.05] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800">
                                    <div className="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                        <svg
                                            className="size-5 sm:size-6"
                                            xmlns="http://www.w3.org/2000/svg"
