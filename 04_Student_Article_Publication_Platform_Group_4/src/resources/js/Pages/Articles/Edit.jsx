...
export default function ArticleEdit({ article, categories = [] }) {
    ...
    const { data, setData, put, processing, errors } = useForm({
        title: article.title,
        category: article.category || categories[0] || 'General',
    ...
    const editorConfig = useMemo(
        () => ({
            readonly: false,
            placeholder: 'Continue writing your article...',
            height: 360,
        }),
        [],
    );
    ...
    return (
        <AuthenticatedLayout header={<h2 className="text-xl font-semibold text-slate-100">Edit Article</h2>}>
