...
class _FavoritesScreenState extends State<FavoritesScreen> {
  ...
  Future<List<_FavoriteData>> _loadFavoritesData() async {
    ...
    for (final breed in breeds) {
      final imageBytes = await prefs.getFavoriteImageBytes(breed) ??
          await api.fetchRandomImageBytes(breed);
      favorites.add(_FavoriteData(breed: breed, imageBytes: imageBytes));
    }
    return favorites;
  }
...
class _FavoriteData {
  ...
  const _FavoriteData({required this.breed, required this.imageBytes});
}
